...
function consultarBaseCliente (nombre){ //agrege esta funcion para consultar un cliente en particular
    for ( const cliente of baseClientes){
...
function menu() {
    ...
    if (registrarse == "SI") {
        ...
        const registroTelefono = prompt("Ingrese su nùmero de telefono")
        datosClientes(registroNombre, registroApellido, registroDni, registroTelefono)
        //consultarBaseClientes(registroNombre) // estan enviando un valor pero la funcion no tiene un parametro donde recibirla
        consultarBaseCliente(registroNombre)
    }
    else if (registrarse == "NO"){
        alert("Gracias por contactarse con nosotros.")
